...
function Logo() {
  return (
    <svg viewBox="0 0 64 64" aria-hidden="true">
      ...
      <path d="M24.5 26v-4.5a7.5 7.5 0 0 1 15 0V26" fill="none" stroke="#da291c" strokeWidth="4" strokeLinecap="round" />
      <path d="M14.5 25.5h35l-3.1 24.6A6.5 6.5 0 0 1 39.9 56H24.1a6.5 6.5 0 0 1-6.5-5.9z" fill="#da291c" />
      <circle cx="26.4" cy="37" r="2.9" fill="#ffc72c" />
      <circle cx="37.6" cy="37" r="2.9" fill="#ffc72c" />
      <path d="M26.2 44.6c1.9 2.7 4 4 5.8 4s3.9-1.3 5.8-4" fill="none" stroke="#ffc72c" strokeWidth="3.1" strokeLinecap="round" />
    </svg>
  );
}
  ...
  return (
    <html lang="es" className={nunito.variable}>
      <body>
        ...
        <main className="py">{children}</main>
      </body>
    </html>
  );
}
